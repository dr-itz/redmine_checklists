...
SimpleCov.coverage_dir( 'plugins/redmine_checklists/coverage')
SimpleCov.start 'rails' do
  add_filter do |source_file|
    # only show files belonging to the plugin, except init.rb which is not fully testable
    source_file.filename.match(/redmine_checklists/) == nil ||
      source_file.filename.match(/redmine_checklists\/init.rb/) != nil
  end
end
